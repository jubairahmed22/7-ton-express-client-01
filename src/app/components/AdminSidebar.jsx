    ...
    const navItems = [
      {
        name: "International",
        submenu: [
          { href: "/admin/international/create-edit-shipping" },
          { href: "/admin/international/all-shipments" },
          { href: "/admin/international/calculate-shipping" },
          { href: "/admin/international/shipping-calculator" },
          { href: "/admin/international/pre-alert" },
        ],
      },
      {
        name: "Domestic",
        submenu: [
          { href: "/admin/domestic/all-shipment" },
          { href: "/admin/domestic/add-shipment" },
          { href: "/admin/domestic/all-order" },
          { href: "/admin/domestic/shipping-calculator" },
        ],
      },
      {
        name: "Users",
      ...
      },
      {
        name: "Configurations",
        submenu: [
          { href: "/admin/configurations/cities" },
          { href: "/admin/configurations/domestic" },
          { 
            href: "/admin/configurations/international",
            submenu: [
              { href: "/admin/configurations/international/shipping" },
              // { href: "/admin/configurations/international/rates" }
            ]
          },
          { href: "/admin/configurations/currencies" },
        ],
      },
    ];
  ...
  const navItems = [
    {
      ...
      submenu: [
        { name: "Create / Add Shipping", href: "/admin/international/create-edit-shipping" },
        { name: "All Shipment List", href: "/admin/international/all-shipments" },
        {
        ...
        { name: "Pre Alert", href: "/admin/international/pre-alert" },
      ],
    },
    {
      name: "Domestic",
      ...
      submenu: [
        { name: "All Shipment", href: "/admin/domestic/all-shipment" },
        { name: "Add Shipment", href: "/admin/domestic/add-shipment" },
        { name: "All Order", href: "/admin/domestic/all-order" },
        { name: "Shipping Calculator", href: "/admin/domestic/shipping-calculator" },
      ],
    },
    {
      name: "Users",
    ...
    },
    {
      ...
      submenu: [
        { name: "Cities", href: "/admin/configurations/cities" },
        { name: "Domestic", href: "/admin/configurations/domestic" },
        { 
          name: "International", 
          href: "/admin/configurations/international",
          submenu: [
            { name: "Shipping Configuration", href: "/admin/configurations/international/shipping" },
            // { name: "Rates Configuration", href: "/admin/configurations/international/rates" }
          ]
        },
        { name: "Currencies", href: "/admin/configurations/currencies" },
      ],
    },
    {
      name: "Warehouses",
    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed z-50 left-4 font-semibold text-gray-600 top-4 p-2 rounded-md bg-white shadow-md md:hidden transition-all duration-300 hover:bg-blue-100"
              ...
              {item.submenu ? (
                <>
                  <button
                    ...
                    className={`flex rounded-lg font-semibold text-gray-600 hover:text-black cursor-pointer items-center w-full px-4 py-3 transition-all duration-300 hover:bg-blue-100 ${
                            ...
                            >
                              {subItem.submenu.map((nestedItem) => (
                                <Link
                                  ...
                                  className={`flex items-center my-1 rounded-lg mt-2 mx-2 text-gray-700 hover:text-black py-3 px-4 pl-16 text-sm transition-all duration-300 ${
                ...
                <Link
                  ...
                  className={`flex w-full justify-start items-center font-semibold rounded-lg text-gray-600 hover:text-black md:justify-start px-4 py-3 transition-all duration-300 ${
                    pathname === item.href ? "bg-blue-100" : "hover:bg-blue-100"
                  } ${isCollapsed ? "px-0" : ""}`}
